        ...
        <div class="file-list">
            <div class="thumbnails my-gallery">
                ...
                <section class="thumbnail" v-if="this.files.length < 5">
                    <div class="add">
                        <span class="add-icon iconfont icon-jia"></span>
                        <input
                            type="file"
                            @change="selectImgs()"
                            multiple
...
export default {
    ...
    methods: {
        ...
        selectImgs() {
            ...
            if (fileList.length > this.maxLength || fileList.length+this.files.length>this.maxLength) {
                this.$toast("Maximum 5 photos with PNG/JPG/jpeg format!");
            }
